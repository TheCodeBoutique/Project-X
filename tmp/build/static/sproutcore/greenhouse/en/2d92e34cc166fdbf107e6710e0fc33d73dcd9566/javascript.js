...
}})}return ret}.property("content").cacheable()});require("core");Greenhouse.File=SC.Record.extend({type:"File",nestedRecordNamespace:Greenhouse,name:SC.Record.attr(String),dir:SC.Record.attr(String),body:SC.Record.attr(String),primaryKey:"id",isFile:YES,path:function(){return this.get("dir")+this.get("name")
...
}.property("parentRecord").cacheable()});require("core");Greenhouse.Dir=SC.Record.extend({type:"Dir",nestedRecordNamespace:Greenhouse,name:SC.Record.attr(String),dir:SC.Record.attr(String),contents:SC.Record.toMany("Greenhouse.File",{nested:YES}),primaryKey:"id",isFile:NO,path:function(){return this.get("dir")+this.get("name")
